...
- Another Project — Short 1‑line description. [Repo](https://github.com/buivantri09/other-repo)
...
(If you prefer, remove or replace any contact method.)

## 🔍 How to explore my work
- Browse my pinned repositories on my GitHub profile.
- Check the repos above for Readmes and live demos.
- Open issues or pull requests if you want to collaborate or give feedback.
...
Thanks for visiting — feel free to say hi or open an issue if you see something interesting!
